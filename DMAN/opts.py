...
parser.add_argument('dataset', type=str, choices=['ucf101', 'diving48','something-v1'])
parser.add_argument('modality', type=str, choices=['RGB', 'RGBDiff'])
parser.add_argument('--lr_scheduler',dest='lr_scheduler', type=str, choices=['cos_warmup', 'lr_step_warmup','lr_step'],default='cos_warmup')
# ========================= Model Configs ==========================
...
parser.add_argument('--partial_bn', dest='partial_bn', action='store_true',help='open residual connection or not, only for TSN',default=False)
# ========================= Learning Configs ==========================
...
parser.add_argument('--rgb_weights_path', default='model/model_rgb.pth',type=str,
...
parser.add_argument('--cuda', type=str, default='0', help='number of gpus')
