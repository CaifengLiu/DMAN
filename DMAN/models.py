...
class TSN(nn.Module):
    def __init__(self, num_class, num_segments, modality,
                 ...
                 dropout=0.8, partial_bn=True,target_transform=None):
...
TSN Configurations:
    ...
    def _prepare_base_model(self, base_model,num_class):
        ...
        if 'resnet' in base_model :
            ...
            checkpoint=torch.load('/home/hulianyu/.torch/models/resnet50-19c8e357.pth')
    ...
    def get_augmentation(self):
        if self.modality == 'RGB':
            return torchvision.transforms.Compose([GroupMultiScaleCrop(self.input_size, [1, .875, .75, .66]),
                                                   GroupRandomHorizontalFlip(is_flow=False,target_transform=self.target_transform)])
